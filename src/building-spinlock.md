...
<span id="index-buildingourown-spinlocks" class="indexterm"></span> <span id="index-spinlocks-buildingourown" class="indexterm"></span>
Locking a regular mutex (see ["Locking: Mutexes and RwLocks" in Chapter 1](basics.html#mutexes))
...
<span id="index-mutexes-spinlocks" class="indexterm"></span>
...
<span id="index-spinning" class="indexterm"></span> <span id="index-busy-looping" class="indexterm"></span>

<div class="admonition admonition-note">

**Note**

<span id="index-mutexes-spinning" class="indexterm"></span>
...
applying what we’ve learned in Chapters [2](atomics.html) and [3](memory-ordering.html),
...
<span id="index-AtomicBool-lockingusing-2" class="indexterm"></span>
...
<span id="index-swapoperationatomic-lockingusing" class="indexterm"></span>
...
It might also result in slightly different instructions, however, as we’ll see in [Chapter 7](hardware.html).

</div>

<span id="index-spinloophint" class="indexterm"></span> <span id="index-hintspinloop" class="indexterm"></span> <span id="index-blocking-spinloop" class="indexterm"></span>
...
hardware, as we’ll see in [Chapter 7](hardware.html).

</div>

<span id="index-releaseandacquirememoryordering-lockingandunlocking-2" class="indexterm"></span> <span id="index-memoryordering-releaseandacquire-lockingandunlocking" class="indexterm"></span> <span id="index-spinlocks-memoryordering" class="indexterm"></span> <span id="index-happens-beforerelationships-lockingandunlocking-2" class="indexterm"></span>
...
[Figure 4-1](#happens-before-diagram-spinlock) visualizes a situation where our `SpinLock` is used
...
<figure id="happens-before-diagram-spinlock">
<div class="image">

</div>
<figcaption>Figure 4-1. The happens-before relationships between two threads using our <code>SpinLock</code> to protect access to some shared data. <a href="alt/4-1.html" class="desc"><img src="desc.svg" title="Image description" alt="Image description" /></a></figcaption>
</figure>
...
<span id="index-interiormutability-2" class="indexterm"></span> <span id="index-UnsafeCell-2" class="indexterm"></span>
Since this data can be mutated (or accessed exclusively) even though the spin lock itself is shared,
we need to use interior mutability (see ["Interior Mutability" in Chapter 1](basics.html#interior-mutability)), for which we’ll use an `UnsafeCell`:
...
<span id="index-Synctrait-implementingforspinlock" class="indexterm"></span>
...
<span id="index-lifetime-elision" class="indexterm"></span>
...
<span id="index-lifetime-specifyingusingplainEnglish" class="indexterm"></span>
...
<span id="index-safeinterface" class="indexterm"></span>
...
<span id="index-guards-spinlockguard" class="indexterm"></span> <span id="index-spinlocks-guard" class="indexterm"></span>
...
<span id="index-lifetime-inastruct" class="indexterm"></span>
...
<span id="index-Dereftrait-2" class="indexterm"></span> <span id="index-DerefMuttrait-3" class="indexterm"></span>
...
<span id="index-Sendtrait-implementingforspinlockguard" class="indexterm"></span> <span id="index-Synctrait-implementingforspinlockguard" class="indexterm"></span>
...
<span id="index-Droptrait-2" class="indexterm"></span>
...
<span id="index-Droptrait-3" class="indexterm"></span> <span id="index-dropfunction-2" class="indexterm"></span>
...
- A `SpinLock<T>` can be implemented with just an `AtomicBool` and an `UnsafeCell<T>`,
  the latter of which is necessary for *interior mutability* (see ["Interior Mutability" in Chapter 1](basics.html#interior-mutability)).
