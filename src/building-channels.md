...
<span id="index-buildingourown-channels" class="indexterm"></span> <span id="index-channels-buildingourown" class="indexterm"></span> *Channels* can be used to send data between threads,
...
<span id="index-mutexes-usingtobuildachannel" class="indexterm"></span> <span id="index-conditionvariables-usingtobuildachannel" class="indexterm"></span>
A basic channel implementation does not require any knowledge of atomics.
<span id="index-VecDeque" class="indexterm"></span>
...
a `Condvar` (see ["Condition Variables" in Chapter 1](basics.html#condvar)) to notify waiting receivers of a new messsage.
...
<span id="index-Synctrait-2" class="indexterm"></span> <span id="index-Sendtrait-2" class="indexterm"></span>
...
<span id="index-one-shotchannels" class="indexterm"></span> <span id="index-channels-one-shot" class="indexterm"></span>
...
The tools we need to start with are basically the same as we used for our `SpinLock<T>` (from [Chapter 4](building-spinlock.html)):
...
<span id="index-MaybeUninit" class="indexterm"></span> <span id="index-uninitializedmemory" class="indexterm"></span>
...
<span id="index-Synctrait-implementingforchannel" class="indexterm"></span>
...
<span id="index-channels-unsafeinterface" class="indexterm"></span>
...
<span id="index-MaybeUninit-2" class="indexterm"></span>
...
We’ll leave it to the user of our channel to use something like thread parking (["Thread Parking" in Chapter 1](basics.html#parking))
...
<span id="index-Copytrait" class="indexterm"></span> <span id="index-MaybeUninit-3" class="indexterm"></span>
...
<span id="index-Copytrait-2" class="indexterm"></span>

A more subtle issue is the lack of a `Drop` implementation for our channel.
<span id="index-Droptrait-4" class="indexterm"></span> <span id="index-leaking-bymistake" class="indexterm"></span> <span id="index-channels-dropping" class="indexterm"></span>
...
<span id="index-safeinterface-2" class="indexterm"></span> <span id="index-channels-safeinterface" class="indexterm"></span>
...
Remember that the *total modification order* (see ["Relaxed Ordering" in Chapter 3](memory-ordering.html#relaxed)) on `ready`
guarantees that after `is_ready` loads `true` from it, `receive` will also see `true`.
<span id="index-relaxedmemoryordering-totalmodificationorder-3" class="indexterm"></span> <span id="index-memoryordering-totalmodificationorder-3" class="indexterm"></span> <span id="index-totalmodificationorder-3" class="indexterm"></span>
...
<span id="index-safeinterface-3" class="indexterm"></span> <span id="index-stressreducing" class="indexterm"></span>
...
<span id="index-relaxedmemoryordering-totalmodificationorder-4" class="indexterm"></span> <span id="index-memoryordering-totalmodificationorder-4" class="indexterm"></span> <span id="index-totalmodificationorder-4" class="indexterm"></span>
We can use relaxed memory ordering for the atomic swap operation,
because the *total modification order* (see ["Relaxed Ordering" in Chapter 3](memory-ordering.html#relaxed)) of `in_use` guarantees
...
<span id="index-Droptrait-5" class="indexterm"></span>
...
<span id="index-atomictypes-getmut" class="indexterm"></span>
...
<span id="index-UnsafeCell-getmut" class="indexterm"></span>
...
<span id="index-threadparking-2" class="indexterm"></span>
...
<span id="index-compare-and-exchangeoperationsatomic-usingforchannelstate" class="indexterm"></span> <span id="index-atomic-compare-and-exchangeoperations-usingforchannelstate" class="indexterm"></span>
...
<span id="index-ownership-moving-2" class="indexterm"></span> <span id="index-consumingargumentsbyvalue" class="indexterm"></span> <span id="index-argumentsconsuming" class="indexterm"></span>
...
<span id="index-channels-SenderandReceivertypes" class="indexterm"></span>
...
<span id="index-channels-storinginArc" class="indexterm"></span> <span id="index-Arc-usingforchannelstate" class="indexterm"></span>
Since the sender and receiver will need to share the ownership of those variables,
we’ll use an `Arc` (["Reference Counting" in Chapter 1](basics.html#arc)) to provide us with a reference-counted shared allocation,
...
<span id="index-Clonetrait-3" class="indexterm"></span>
...
<span id="index-Droptrait-6" class="indexterm"></span>
...
<span id="index-channels-borrowing" class="indexterm"></span> <span id="index-channels-storinginArc-avoiding" class="indexterm"></span>

We will also have to trade in some simplicity, since we will now have to deal with borrowing and lifetimes.

<span id="index-channels-SenderandReceivertypes-2" class="indexterm"></span>
...
<span id="index-borrowing-splitting" class="indexterm"></span> <span id="index-splittingborrowing" class="indexterm"></span>
...
<span id="index-lifetime-elision-2" class="indexterm"></span>
...
<span id="index-blocking-channel" class="indexterm"></span> <span id="index-channels-blocking" class="indexterm"></span>
...
<span id="index-threadparking-3" class="indexterm"></span> <span id="index-Threadobject" class="indexterm"></span> <span id="index-Threadobject-unpark-2" class="indexterm"></span> <span id="index-unparkThread" class="indexterm"></span>
...
<span id="index-Sendtrait-3" class="indexterm"></span> <span id="index-threadsafety-keepingobjectsononethread" class="indexterm"></span>
As discussed in ["Thread Safety: Send and Sync" in Chapter 1](basics.html#thread-safety),
we can use the special `PhantomData` marker type to add this restriction to our struct.
<span id="index-PhantomData-2" class="indexterm"></span>
...
<span id="index-handthingsgettingoutof" class="indexterm"></span>
