...
<span id="index-atomic" class="indexterm"></span> <span id="index-ἄτομος" class="indexterm"></span> <span id="index-indivisible" class="indexterm"></span>
...
<span id="index-dataraces-avoidingusingatomics" class="indexterm"></span>
As mentioned in ["Borrowing and Data Races" in Chapter 1](basics.html#borrowing-and-races),
...
Later, in [Chapter 7](hardware.html), we’ll see how this works at the hardware level.
...
<span id="index-atomictypes-2" class="indexterm"></span> <span id="index-AtomicBool" class="indexterm"></span> <span id="index-AtomicPtr" class="indexterm"></span>
...
<span id="index-sharedreferences-mutatingatomicsthrough" class="indexterm"></span>
Unlike most types, they allow modification through a shared reference (e.g., `&AtomicU8`).
This is possible thanks to interior mutability, as discussed in ["Interior Mutability" in Chapter 1](basics.html#interior-mutability).
...
<span id="index-memoryordering" class="indexterm"></span>

<span id="index-Ordering" class="indexterm"></span> <span id="index-Ordering-Relaxed" class="indexterm"></span> <span id="index-relaxedmemoryordering" class="indexterm"></span> <span id="index-memoryordering-relaxed" class="indexterm"></span>
...
memory orderings in [Chapter 3](memory-ordering.html).

## Atomic Load and Store Operations

<span id="index-atomic-loadandstoreoperations" class="indexterm"></span> <span id="index-loadandstoreoperationsatomic" class="indexterm"></span>
...
<span id="index-atomictypes-load" class="indexterm"></span> <span id="index-atomictypes-store" class="indexterm"></span>
...
<span id="index-loadandstoreoperationsatomic-examplestopflag" class="indexterm"></span> <span id="index-atomic-loadandstoreoperations-examplestopflag" class="indexterm"></span> <span id="index-stopflag" class="indexterm"></span>
...
<span id="index-atomic-loadandstoreoperations-exampleprogressreporting" class="indexterm"></span> <span id="index-loadandstoreoperationsatomic-exampleprogressreporting" class="indexterm"></span>
...
This time, we use a scoped thread (["Scoped Threads" in Chapter 1](basics.html#scoped-threads)),
...
To solve this, we can use thread parking (["Thread Parking" in Chapter 1](basics.html#parking)) to wake the main thread from its sleep
...
<span id="index-threadparking-timeout-example" class="indexterm"></span> <span id="index-timeout-threadparking-example" class="indexterm"></span>
...
<span id="index-loadandstoreoperationsatomic-examplelazyinitialization" class="indexterm"></span> <span id="index-atomic-loadandstoreoperations-examplelazyinitialization" class="indexterm"></span> <span id="index-lazyinitialization-usingloadandstore" class="indexterm"></span>
...
<span id="index-racing" class="indexterm"></span>
...
You could implement this using a condition variable or thread parking (["Waiting: Parking and Condition Variables" in Chapter 1](basics.html#waiting)),
...
<span id="index-OnceandOnceLock" class="indexterm"></span> <span id="index-blocking-OnceandOnceLock" class="indexterm"></span>

## Fetch-and-Modify Operations

<span id="index-atomic-fetch-and-modifyoperations" class="indexterm"></span> <span id="index-fetch-and-modifyoperationsatomic" class="indexterm"></span>
...
Their function signatures are as follows, using `AtomicI32` as an example:
<span id="index-atomictypes-fetchadd" class="indexterm"></span> <span id="index-atomictypes-fetchsub" class="indexterm"></span> <span id="index-atomictypes-fetchor" class="indexterm"></span> <span id="index-atomictypes-fetchand" class="indexterm"></span> <span id="index-atomictypes-fetchnand" class="indexterm"></span> <span id="index-atomictypes-fetchxor" class="indexterm"></span> <span id="index-atomictypes-fetchmax" class="indexterm"></span> <span id="index-atomictypes-fetchmin" class="indexterm"></span> <span id="index-atomictypes-swap" class="indexterm"></span>
...
<span id="index-swapoperationatomic" class="indexterm"></span>
...
<span id="index-wrappingbehaviorfetchaddandfetchsub" class="indexterm"></span> <span id="index-atomictypes-fetchadd-wrappingbehavior" class="indexterm"></span> <span id="index-atomictypes-fetchsub-wrappingbehavior" class="indexterm"></span> <span id="index-atomic-fetch-and-modifyoperations-wrappingbehavioraddandsub" class="indexterm"></span> <span id="index-fetch-and-modifyoperationsatomic-wrappingbehavioraddandsub" class="indexterm"></span>
...
<span id="index-atomic-fetch-and-modifyoperations-exampleprogressreporting" class="indexterm"></span> <span id="index-fetch-and-modifyoperationsatomic-exampleprogressreporting" class="indexterm"></span>
In ["Example: Progress Reporting"](#example-progress-reporting),
...
<span id="index-Copytrait-atomictypesnotimplementing" class="indexterm"></span>
...
<span id="index-fetch-and-modifyoperationsatomic-examplestatistics" class="indexterm"></span> <span id="index-atomic-fetch-and-modifyoperations-examplestatistics" class="indexterm"></span>
...
<span id="index-Instant" class="indexterm"></span>
...
<span id="index-atomic-fetch-and-modifyoperations-exampleIDallocation" class="indexterm"></span> <span id="index-fetch-and-modifyoperationsatomic-exampleIDallocation" class="indexterm"></span> <span id="index-IDallocation-usingfetchadd" class="indexterm"></span>
...
<span id="index-overflowsatomic" class="indexterm"></span>
...
<span id="index-overflowsatomic-panickingon" class="indexterm"></span>
...
<span id="index-abortingtheprocess" class="indexterm"></span> <span id="index-overflowsatomic-abortingon" class="indexterm"></span>
...
<span id="index-atomic-compare-and-exchangeoperations" class="indexterm"></span> <span id="index-compare-and-exchangeoperationsatomic" class="indexterm"></span>
...
<span id="index-atomictypes-compareexchange" class="indexterm"></span>
...
We calculate the new value we want to store in `a`,
not taking into account potential concurrent modifications of `a` by other threads.

<span class="callout">3</span>

We use `compare_exchange` to update the value of `a`,
but *only* if its value is still the same value we loaded before.

<span class="callout">4</span>

If `a` was indeed still the same as before,
it is now replaced by our new value and we are done.

<span class="callout">5</span>

If `a` was not the same as before,
...
<span id="index-ABAproblem" class="indexterm"></span>
This is known as the *ABA problem*.

</div>

<span id="index-atomictypes-compareexchangeweak" class="indexterm"></span> <span id="index-atomic-compare-and-exchangeoperations-weak" class="indexterm"></span> <span id="index-compare-and-exchangeoperationsatomic-weak" class="indexterm"></span>
...
In [Chapter 7](hardware.html), we’ll dive into the low-level details
to find out why the weak version can be more efficient.

### Example: ID Allocation Without Overflow

<span id="index-compare-and-exchangeoperationsatomic-exampleIDallocation" class="indexterm"></span> <span id="index-atomic-compare-and-exchangeoperations-exampleIDallocation" class="indexterm"></span> <span id="index-IDallocation-usingcompareexchangeweak" class="indexterm"></span>
Now, back to our overflow problem in `allocate_new_id()` from ["Example: ID Allocation"](#example-id-allocation).

<span id="index-overflowsatomic-preventingcompare-and-exchange" class="indexterm"></span>
...
<span id="index-fetchupdateatomic" class="indexterm"></span> <span id="index-atomictypes-fetchupdate" class="indexterm"></span>
...
<span id="index-IDallocation-usingfetchupdate" class="indexterm"></span>
...
<span id="index-compare-and-exchangeoperationsatomic-examplelazyinitialization" class="indexterm"></span> <span id="index-atomic-compare-and-exchangeoperations-examplelazyinitialization" class="indexterm"></span> <span id="index-lazyinitialization-usingcompareexchange" class="indexterm"></span>
In ["Example: Lazy Initialization"](#example-lazy-init), we looked at an example of lazy initialization of a constant value.
...
If we swapped the zero for our new key, we return our newly generated key.
New invocations of `get_key()` will return the same new key that’s now stored in `KEY`.

<span class="callout">4</span>

If we lost the race to another thread that initialized `KEY` before we could,
...
As mentioned in ["Example: Lazy Initialization"](#example-lazy-init),
...
<span id="index-blocking-OnceandOnceLock-2" class="indexterm"></span> <span id="index-OnceandOnceLock-2" class="indexterm"></span>
...
- The relative ordering of atomic operations is tricky when multiple variables are involved. More in [Chapter 3](memory-ordering.html).
