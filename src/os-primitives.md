...
# [Chapter 8. Operating System Primitives]()
  ...
  As we saw in [Chapter 4](building-spinlock.html), we can do this ourselves without the help of the operating system by *spinning*, repeatedly trying something over and over again, which can easily waste a lot of processor time. If we want to block efficiently, however, we need the help of the operating system's kernel.
...
### [Priority Inheritance Futex Operations](#priority-inheritance-futex-operations)
...
### [Heavyweight Kernel Objects](#heavyweight-kernel-objects)
...
:: {#lighter-weight-objects .section}
### [Lighter-Weight Objects](#lighter-weight-objects)
...
: {#windows-srw .section}
#### [Slim reader-writer locks](#windows-srw)
...
### [Address-Based Waiting](#address-based-waiting)
...
Some, but not all, of the synchronization primitives of the Windows API are implemented using these functions. More importantly, they are a great building block for building our own primitives, which we will do in [Chapter 9](building-locks.html).
...
[Next: Chapter 9. Building Our Own Locks](building-locks.html)
::::::::::::::::::::::
