...
<span id="index-ideasandinspiration" class="indexterm"></span> <span id="index-inspiration" class="indexterm"></span>
...
<span id="index-semaphores" class="indexterm"></span>
...
<span id="index-blocking-semaphores" class="indexterm"></span>
...
Most notably, on platforms that support futex-like operations (["Futex" in Chapter 8](os-primitives.html#futex)),
it can be implemented more efficiently as a single `AtomicU32` (or even `AtomicU8`).

<span id="index-binarysemaphore" class="indexterm"></span>
...
- [Wikipedia article on semaphores](https://oreil.ly/_rSRZ)

- [Stanford University course notes on semaphores](https://oreil.ly/ZVaei)

## RCU

<span id="index-RCUreadcopyupdate" class="indexterm"></span>
...
When ready, the atomic pointer can be updated using a compare-and-exchange operation (["Compare-and-Exchange Operations" in Chapter 2](atomics.html#cas)),
...
<span id="index-Linux-RCU" class="indexterm"></span>
...
- [Wikipedia article on the read-copy-update pattern](https://oreil.ly/egIIi)

- [LWN article "What is RCU, Fundamentally?"](https://oreil.ly/GQZ6r)

## Lock-Free Linked List

<span id="index-RCUreadcopyupdate-2" class="indexterm"></span> <span id="index-linkedlist" class="indexterm"></span>
...
- [Wikipedia article on non-blocking linked lists](https://oreil.ly/kVQ1O)

- [LWN article "Using RCU for Linked Lists—A Case Study"](https://oreil.ly/H0lt4)

## Queue-Based Locks

<span id="index-queue-basedlocks" class="indexterm"></span>
...
<span id="index-slimreader-writerlocksWindows-2" class="indexterm"></span> <span id="index-Windows-SRWlocks-2" class="indexterm"></span> <span id="index-SRWlocksWindows-2" class="indexterm"></span>
Windows SRW locks (["Slim reader-writer locks" in Chapter 8](os-primitives.html#windows-srw)) are implemented using this pattern.

Further reading:

- [Notes on the implementation of Windows SRW locks](https://oreil.ly/El8GA)

- [A Rust implementation of queue-based locks](https://oreil.ly/aFyg1)

## Parking Lot–Based Locks

<span id="index-parkinglot-basedlocks" class="indexterm"></span>
...
<span id="index-parkinglotcrate" class="indexterm"></span>
...
- [WebKit blog post, "Locking in WebKit"](https://oreil.ly/6dPim)

- [Documentation of the `parking_lot` crate](https://oreil.ly/UPcXu)

## Sequence Lock

<span id="index-sequencelocks" class="indexterm"></span>
...
- [Wikipedia article on Linux’s Seqlock](https://oreil.ly/T28bW)

- [Rust RFC 3301, `AtomicPerByte`](https://oreil.ly/Qavc7)

- [Documentation of the `seqlock` crate](https://oreil.ly/yHd_7)

## Teaching Materials

<span id="index-teaching" class="indexterm"></span>
...
<span id="index-luckgood" class="indexterm"></span> <span id="index-goodluck" class="indexterm"></span>
