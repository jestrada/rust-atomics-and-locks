...
I first learned of Rust from any number of enthusiasts and Linux-related conferences. Nevertheless, I was happily minding my own business until I was called out by name in a Rust-related LWN article, [\"Using Rust for Kernel Development\"](https://lwn.net/Articles/870555/). Thus prodded, I wrote a blog series entitled [\"So You Want to Rust the Linux Kernel?\"](https://paulmck.livejournal.com/62436.html) This blog series sparked a number of spirited discussions, a few of which are visible in the series\' comments.
