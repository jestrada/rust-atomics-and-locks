...
<span id="index-buildingourown-Arc" class="indexterm"></span> <span id="index-Arc-buildingourown" class="indexterm"></span>
In ["Reference Counting" in Chapter 1](basics.html#arc), we saw the `std::sync::Arc<T>`
...
<span id="index-pointers-NonNull" class="indexterm"></span> <span id="index-NonNull" class="indexterm"></span>
...
<span id="index-Sendtrait-implementingforArc" class="indexterm"></span> <span id="index-Synctrait-implementingforArc" class="indexterm"></span>
...
<span id="index-Box-leak-2" class="indexterm"></span>
...
<span id="index-Dereftrait-3" class="indexterm"></span>
...
<span id="index-Clonetrait-4" class="indexterm"></span>
...
<span id="index-relaxedmemoryordering-referencecounting" class="indexterm"></span> <span id="index-memoryordering-referencecounting" class="indexterm"></span>
...
<span id="index-overflowsatomic-referencecounter" class="indexterm"></span>
...
["Example: ID Allocation" in Chapter 2](atomics.html#example-id-allocation) and
["Example: ID Allocation Without Overflow" in Chapter 2](atomics.html#example-handle-overflow) to handle this issue.
...
<span id="index-Box-fromraw-2" class="indexterm"></span> <span id="index-Droptrait-7" class="indexterm"></span>
...
<span id="index-Arc-memoryordering" class="indexterm"></span> <span id="index-happens-beforerelationships-inArc" class="indexterm"></span>
...
<span id="index-memoryordering-referencecounting-2" class="indexterm"></span> <span id="index-releaseandacquirememoryordering-referencecounting" class="indexterm"></span>
...
<span id="index-fences-2" class="indexterm"></span> <span id="index-memoryordering-fences-2" class="indexterm"></span> <span id="index-releaseandacquirememoryordering-acquirefence-3" class="indexterm"></span>
...
<span id="index-Droptrait-8" class="indexterm"></span>
...
<span id="index-Miri" class="indexterm"></span> <span id="index-undefinedbehavior-Miridetectingwith" class="indexterm"></span>
...
<span id="index-memoryordering-Miridetectingproblemswith" class="indexterm"></span>
...
<span id="index-DerefMuttrait-4" class="indexterm"></span>
...
<span id="index-Arc-getmut" class="indexterm"></span>
...
<span id="index-happens-beforerelationships-inArc-2" class="indexterm"></span> <span id="index-releaseandacquirememoryordering-referencecounting-2" class="indexterm"></span> <span id="index-memoryordering-referencecounting-3" class="indexterm"></span> <span id="index-Arc-memoryordering-2" class="indexterm"></span>
...
<span id="index-releaseandacquirememoryordering-acquirefence-4" class="indexterm"></span>
...
<span id="index-cyclicstructuresArc" class="indexterm"></span> <span id="index-Arc-cyclicstructures" class="indexterm"></span>
...
<span id="index-Arc-weakpointers" class="indexterm"></span>
...
<span id="index-interiormutability-3" class="indexterm"></span> <span id="index-UnsafeCell-3" class="indexterm"></span>
We’ll use an `Option<T>` so we can use `None` for when the data is dropped,
and wrap that in an `UnsafeCell` for *interior mutability* (["Interior Mutability" in Chapter 1](basics.html#interior-mutability)),
...
<span id="index-Clonetrait-5" class="indexterm"></span>
...
<span id="index-Droptrait-9" class="indexterm"></span>
...
<span id="index-Droptrait-10" class="indexterm"></span> <span id="index-dropfunction-3" class="indexterm"></span>
...
We’ll use a compare-and-exchange loop (["Compare-and-Exchange Operations" in Chapter 2](atomics.html#cas)) to do this.
...
<span id="index-Arc-weakpointers-performancecost" class="indexterm"></span>
...
such that it repeatedly cycles through moments where it holds no `Arc` (<span class="callout">1</span>), and moments where it holds no `Weak` (<span class="callout">2</span>).
...
if we are unlucky and check the `Arc` counter during its first print statement (<span class="callout">1</span>),
but check the `Weak` counter during its second print statement (<span class="callout">2</span>).
...
<span id="index-ManuallyDrop" class="indexterm"></span>
...
<span id="index-Droptrait-11" class="indexterm"></span>
...
such as in the example case we saw at the start of ["Optimizing"](#optimizing-arc).
...
<span id="index-compare-and-exchangeoperationsatomic-usingtolockreferencecounter" class="indexterm"></span> <span id="index-atomic-compare-and-exchangeoperations-usingtolockreferencecounter" class="indexterm"></span>
...
<span id="index-Arc-memoryordering-3" class="indexterm"></span> <span id="index-releaseandacquirememoryordering-referencecounting-3" class="indexterm"></span> <span id="index-memoryordering-referencecounting-4" class="indexterm"></span>
...
<span id="index-fences-3" class="indexterm"></span> <span id="index-memoryordering-fences-3" class="indexterm"></span> <span id="index-releaseandacquirememoryordering-acquirefence-5" class="indexterm"></span>
...
<span id="index-spinning-2" class="indexterm"></span>
...
<span id="index-releaseandacquirememoryordering-referencecounting-4" class="indexterm"></span> <span id="index-memoryordering-referencecounting-5" class="indexterm"></span> <span id="index-Arc-memoryordering-4" class="indexterm"></span>
...
If we run the exact same test as before (["Testing It"](#arc-weak-test)),
